...
import IMG_SUPERMATT from "./assets/new uploaded wrappers/Super Matt 4L Bucket (2).png";
import IMG_NC_SANDING_SEALER from "./assets/new uploaded wrappers/NC Sanding sealer 4L Tin (2).png";
import IMG_PEARL_COAT from "./assets/new uploaded wrappers/Pearl Coat 4L.png";
...
const PRODUCTS = [
  ...
  { id: "standard-emulsion", name: "Standard Emulsion", category: "interior", desc: "Acrylic emulsion for interior conditions and moderate exterior environments on wood and concrete.", longDesc: "Peacock Standard Emulsion is an acrylic emulsion designed to withstand interior conditions and moderate harsh exterior environments. It is suitable for application on both wood and concrete surfaces.\n\nPrepare surfaces by sanding to remove dirt and grease, scraping away loose paint, filling cracks with Peacock Undercoat Putty, and sanding smoothly once dry.\n\nDilute 4 litres of paint with 1 litre of water. Apply by brush or roller and store in a cool dry place out of reach of children.", sizes: [{ size: "4L", price: 65000, coverage: "12-15m²" }, { size: "20L", price: 150000, coverage: "60-75m²" }], img: null, tag: "New", colours: "Multiple colours", finish: "Matt", dryTime: "20-30 mins touch dry, 5 hrs through dry", coats: "2 coats recommended", surface: "Wood & concrete", rating: 4.6, reviews: 24 },
  { id: "supermatt-emulsion", name: "Supermatt Emulsion", category: "interior", desc: "Matt acrylic emulsion for interior and exterior ceiling areas on wood and cement plaster.", longDesc: "Peacock Supermatt Emulsion is an acrylic emulsion with a matt finish, formulated for application on interior and exterior ceiling areas. It can be used on surfaces of wood and cement plaster.\n\nClean all surfaces, sand them, and prime with Peacock Plaster Primer or Latex Primer Sealer. Fill dents and imperfections with Peacock Undercoat Putty before applying the finish.\n\nDilute 4 litres of paint with 1 litre of water. Apply one coat, allowing one hour of drying time between coats using a paint roller or brush.", sizes: [{ size: "1L", price: 18000, coverage: "8-10m²" }, { size: "4L", price: 60000, coverage: "32-40m²" }, { size: "20L", price: 140000, coverage: "160-200m²" }], img: IMG_SUPERMATT, tag: "New", colours: "Multiple colours", finish: "Matt", dryTime: "15-30 mins touch dry", coats: "2 coats recommended", surface: "Ceilings, wood & cement plaster", rating: 4.7, reviews: 31 },
  { id: "undercoat-putty", name: "Undercoat Putty", category: "specialist", desc: "Latex-based filler for cracks and dents, creating a smooth substrate for primer and finish coats.", longDesc: "Peacock Undercoat Putty is a latex-based filler designed to fill cracks and dents, creating a perfectly leveled surface for primer and finish coats. It ensures a smooth, flaw-free substrate with minimal effort.\n\nUse a steel float for larger jobs or a pallet knife for smaller repairs. Once dry, sand the surface smooth before priming or painting.\n\nThe product is supplied in white and should be stored in a cool dry place out of reach of children.", sizes: [{ size: "1Kg", price: 12000, coverage: "0.33m²" }, { size: "6Kg", price: 55000, coverage: "2m²" }, { size: "30Kg", price: 180000, coverage: "10m²" }], img: null, tag: "Specialist", colours: "White", finish: "Smooth filler", dryTime: "10-20 mins", coats: "Apply as needed", surface: "Cracks, dents & wall imperfections", rating: 4.6, reviews: 38 },
  { id: "venetian-stucco", name: "Venetian Stucco", category: "specialist", desc: "Water-based anti-mold decorative plaster for polished marble-like interior walls and ceilings.", longDesc: "Peacock Venetian Stucco is a water-based, antifungal, and anti-mold plaster engineered with natural additives, fillers, and pigments to create a polished marble-like finish for interior walls and ceilings. It provides moisture resistance, abrasion resistance, easy cleanability, and low odour for durable, elegant surfaces.\n\nAll substrates must be thoroughly dry, structurally sound, and free of contaminants including dust, loose material, grease, and oil. Prime surfaces with Peacock Latex Primer Sealer to ensure optimal adhesion and a uniform finish.\n\nApply multiple coats with sanding between stages, then finish by applying wax in circular motions with a cloth and buffing to a polished marble-like effect.", sizes: [{ size: "4Kg", price: 85000, coverage: "3.3-4m²" }, { size: "20Kg", price: 360000, coverage: "16.6-20m²" }], img: null, tag: "Specialist", colours: "Decorative colours", finish: "Polished marble effect", dryTime: "6 hrs between early coats, 24 hrs cure", coats: "Multi-coat system", surface: "Interior walls & ceilings", rating: 4.8, reviews: 19 },
  { id: "nc-sanding-sealer", name: "NC Sanding Sealer", category: "specialist", desc: "Quick-drying wood care sealer that fills timber pores for a smooth, even surface.", longDesc: "Peacock NC Sanding Sealer is a nitrocellulose wood care product formulated to seal off pores in timber surfaces. It is very quick drying and contains special polishing agents that help fill pores while sanding, generating a smooth and even surface.\n\nClean and sand the timber with a hand or oscillating sander, remove dust with vacuum equipment, and stain the timber if necessary. Mix the sealer with Sync Thinner and apply 2-3 coats, allowing 20-30 minutes between coats.\n\nSand down the first coat before the second coat is applied using a 240 grit abrasive pad or paper.", sizes: [{ size: "1L", price: 30000, coverage: "4-6m²" }, { size: "4L", price: 100000, coverage: "16-24m²" }], img: IMG_NC_SANDING_SEALER, tag: "Specialist", colours: "Clear", finish: "Sealed smooth finish", dryTime: "15 mins touch dry, 30 mins recoatable", coats: "2-3 coats", surface: "Timber & woodwork", rating: 4.7, reviews: 27 },
...
const navData = [
  ...
  { label: "Paints", columns: [
    { title: "Interior", links: ["Premium Matt Emulsion","Vinyl Silk Makula","Gloss Emulsion","Undercoat Emulsion","Standard Emulsion","Supermatt Emulsion"], footer: [{ label: "All interior paints" }] },
    ...
    { title: "Specialist", links: ["Plaster Primer","Epoxy 2K Enamel","Cellulose Enamel","2K Acrylic Polyurethane","Acrylic Art Paint","Undercoat Putty","Venetian Stucco","NC Sanding Sealer","Pearl Coat","Sync Thinner"], footer: [{ label: "All specialist paints" }] },
          ...
          {products.map(p => (
            <a key={p.id} href={productHrefFn(p)} onClick={e => { e.preventDefault(); onOpenProduct(p); }}
              ...
              <div style={{ background: B.off, padding: "20px 16px", display: "flex", alignItems: "center", justifyContent: "center", height: 200, position: "relative" }}>
                {p.img && <img src={p.img} alt={p.name} style={{ maxHeight: 170, maxWidth: "80%", objectFit: "contain", filter: "drop-shadow(0 6px 12px rgba(0,0,0,.12))" }} />}
...
// ═══════ PRODUCT DETAIL PAGE ═══════
const ProductDetailPage = ({ product, onBack, onAddToCart, onOpenProduct }) => {
        ...
        <div className="g2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "start" }}>
          ...
          <div>
            <div style={{ background: B.off, borderRadius: 16, padding: "40px", display: "flex", alignItems: "center", justifyContent: "center", minHeight: 480, position: "relative" }}>
              {product.img && <img src={product.img} alt={product.name} style={{ maxHeight: 400, maxWidth: "85%", objectFit: "contain", filter: "drop-shadow(0 12px 32px rgba(0,0,0,0.15))" }} />}
              ...
              {related.map(r => (
                <div key={r.id} onClick={() => onOpenProduct(r)}
                  ...
                  <div style={{ background: B.off, padding: 20, display: "flex", alignItems: "center", justifyContent: "center", height: 180 }}>
                    {r.img && <img src={r.img} alt={r.name} style={{ maxHeight: 160, maxWidth: "75%", objectFit: "contain", filter: "drop-shadow(0 4px 8px rgba(0,0,0,0.1))" }} />}
                  </div>
